...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlipbookPage.page_type'
        db.add_column(u'flipbook_flipbookpage', 'page_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlipbookPage.page_type'
        db.delete_column(u'flipbook_flipbookpage', 'page_type')
