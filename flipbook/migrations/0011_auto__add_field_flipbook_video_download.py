...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'flipbook_flipbook', 'video_download',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='video_download_flipbooks', null=True, to=orm['filer.File']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flipbook.video_download'
        db.delete_column(u'flipbook_flipbook', 'video_download_id')
