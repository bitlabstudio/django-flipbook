...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Flipbook.folder'
        db.delete_column(u'flipbook_flipbook', 'folder_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Flipbook.folder'
        raise RuntimeError("Cannot reverse this migration. 'Flipbook.folder' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Flipbook.folder'
        db.add_column(u'flipbook_flipbook', 'folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Folder']),
                      keep_default=False)
