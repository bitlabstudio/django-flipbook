...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flipbook.category'
        db.add_column(u'flipbook_flipbook', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='flipbooks', null=True, to=orm['flipbook.FlipbookCategory']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Flipbook.category'
        db.delete_column(u'flipbook_flipbook', 'category_id')
