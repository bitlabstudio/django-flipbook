...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flipbook.url'
        db.add_column(u'flipbook_flipbook', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Flipbook.email'
        db.add_column(u'flipbook_flipbook', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flipbook.url'
        db.delete_column(u'flipbook_flipbook', 'url')

        # Deleting field 'Flipbook.email'
        db.delete_column(u'flipbook_flipbook', 'email')
