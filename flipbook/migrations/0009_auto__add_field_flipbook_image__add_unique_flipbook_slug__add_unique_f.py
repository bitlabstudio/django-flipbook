...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flipbook.image'
        db.add_column(u'flipbook_flipbook', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='flipbooks', null=True, to=orm['filer.Image']),
                      keep_default=False)

        # Adding unique constraint on 'Flipbook', fields ['slug']
        db.create_unique(u'flipbook_flipbook', ['slug'])

        # Adding unique constraint on 'FlipbookCategory', fields ['slug']
        db.create_unique(u'flipbook_flipbookcategory', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'FlipbookCategory', fields ['slug']
        db.delete_unique(u'flipbook_flipbookcategory', ['slug'])

        # Removing unique constraint on 'Flipbook', fields ['slug']
        db.delete_unique(u'flipbook_flipbook', ['slug'])

        # Deleting field 'Flipbook.image'
        db.delete_column(u'flipbook_flipbook', 'image_id')
