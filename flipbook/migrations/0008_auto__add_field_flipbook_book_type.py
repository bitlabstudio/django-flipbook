...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Flipbook.book_type'
        db.add_column(u'flipbook_flipbook', 'book_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Flipbook.book_type'
        db.delete_column(u'flipbook_flipbook', 'book_type')
