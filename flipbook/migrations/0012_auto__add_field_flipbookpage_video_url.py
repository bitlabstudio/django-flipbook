...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlipbookPage.video_url'
        db.add_column('flipbook_flipbookpage', 'video_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlipbookPage.video_url'
        db.delete_column('flipbook_flipbookpage', 'video_url')
