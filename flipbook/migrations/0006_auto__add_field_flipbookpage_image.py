...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'flipbook_flipbookpage', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pages', null=True, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlipbookPage.image'
        db.delete_column(u'flipbook_flipbookpage', 'image_id')
