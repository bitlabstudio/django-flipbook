...
class Flipbook(models.Model):
    ...
    :url: Optional external url.
    :email: Optional email address.
    :password: Password to hide the book for unwanted users.
    ...
    book_type = models.CharField(
        max_length=256,
        verbose_name=_("Type"),
        choices=getattr(settings, "FLIPBOOK_BOOK_TYPE", (("default", _("default")),)),
        blank=True,
    )
...
class FlipbookPage(models.Model):
    ...
    page_type = models.CharField(
        max_length=256,
        verbose_name=_("Type"),
        choices=getattr(settings, "FLIPBOOK_PAGE_TYPE", (("default", _("default")),)),
        blank=True,
    )
